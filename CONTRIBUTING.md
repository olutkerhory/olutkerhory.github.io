...
Kaikki muut osallistujat voivat lähettää muutoksia **pull requestina** omasta
forkista.

## Haluatko kirjoitusoikeuden?
...
## Pull requestin lähettäminen ilman push-oikeutta

1. **Forkkaa** repo omalle tilillesi (GitHub UI:n "Fork"-nappi).
...
Uudet postaukset lisätään `posts/`-kansioon markdown-tiedostoina. Tarkka
frontmatter-skeema ja paikallinen kehitysohje ovat
[README:ssä](./README.md#postauksen-lisääminen).

## Kysymyksiä?

Avaa issue tai ota yhteyttä org-ylläpitäjiin.
